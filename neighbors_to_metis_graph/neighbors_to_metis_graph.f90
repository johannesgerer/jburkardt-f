...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Write triangle or tet mesh neighbors in MeTiS graph file format.'
!
...
!*****************************************************************************80
!
!! I4COL_COMPARE compares columns I and J of a integer ( kind = 4 ) array.
!
!  Example:
!
!    Input:
...
!*****************************************************************************80
!
!! I4COL_SORT_A ascending sorts an integer ( kind = 4 ) array of columns.
!
!  Discussion:
!
...
!
  ...
  write ( output_unit, '(a)' ) '%  MeTiS GraphFile "' // trim ( output_file_name ) // '".'
  write ( output_unit, '(a)' ) '%'
