...
!  Parameters:
!
!    Input, integer ( kind = 4 ) INPUT_UNIT, the FORTRAN unit associated with the input file.
!
...
!  Parameters:
!
!    Input, integer ( kind = 4 ) INPUT_UNIT, the FORTRAN unit associated with the
!    input file.
!
!    Input, integer ( kind = 4 ) OUTPUT_UNIT, the FORTRAN unit associated with the
!    output file.
!
...
!*****************************************************************************80
!
!! S_OF_I4 converts an integer ( kind = 4 ) to a left-justified string.
!
!  Example:
!
!         I  S
...
!  Parameters:
!
!    Input, integer ( kind = 4 ) I, an integer ( kind = 4 ) to be converted.
!
!    Output, character ( len = 11 ) S_OF_I4, the representation of the
!    integer ( kind = 4 ).  The integer ( kind = 4 ) will be left-justified.
!
  implicit none
  ...
  ihi = 11
!
!  Make a copy of the integer ( kind = 4 ).
!
  ival = i
!
