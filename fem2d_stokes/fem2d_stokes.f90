...
!    of the nodes.
!
!    Input, integer ( kind = 4 ) NODE_P_VARIABLE(NODE_NUM), the index of the pressure
!    variable associated with a node, or -1 if there is none.
!
!    Input, integer ( kind = 4 ) NODE_U_VARIABLE(NODE_NUM), the index of the horizontal
!    velocity variable associated with a node, or -1 if there is none.
!
!    Input, integer ( kind = 4 ) NODE_V_VARIABLE(NODE_NUM), the index of the vertical
!    velocity variable associated with a node, or -1 if there is none.
!
!    Input, integer ( kind = 4 ) ELEMENT_NODE(6,ELEMENT_NUM), the nodes that form each
...
!    Input, integer ( kind = 4 ) ELEMENT_NUM, the number of triangles.
!
!    Input, integer ( kind = 4 ) ELEMENT_NODE(6,ELEMENT_NUM), lists, for each triangle,
...
!    Input, integer ( kind = 4 ) NODE_NUM, the number of nodes.
!
!    Input, integer ( kind = 4 ) NODE_U_VARIABLE(NODE_NUM), NODE_V_VARIABLE(NODE_NUM),
