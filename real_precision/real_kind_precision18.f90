...
!*****************************************************************************80
!
!! MAIN is the main program for REAL_KIND_PRECISION18.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'REAL_KIND_PRECISION18'
  write ( *, '(a)' ) '  FORTRAN90 version.'
  write ( *, '(a)' ) '  Inquire about the properties of real data that'
  write ( *, '(a)' ) '  is requested with a precision of 18 decimal digits'
...
!    a precision of 18 decimal digits and a maximum exponent of 30.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  integer, parameter :: precision18 = selected_real_kind ( 18, 30 )
  real ( kind = precision18 ) r

  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  Use SELECTED_REAL_KIND to request real numbers'
  write ( *, '(a)' ) '  with a precision of 18 decimal digits.'

  if ( precision18 == -1 ) then
    write ( *, '(a)' ) ' '
