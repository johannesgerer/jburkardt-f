...
!*****************************************************************************80
!
!! MAIN is the main program for REAL_KIND_PRECISION6.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'REAL_KIND_PRECISION6'
  write ( *, '(a)' ) '  FORTRAN90 version.'
  write ( *, '(a)' ) '  Inquire about the properties of real data that'
  write ( *, '(a)' ) '  is requested with a precision of 6 decimal digits'
  write ( *, '(a)' ) '  and max exponent 30.'
...
!*****************************************************************************80
!
!! TEST01 examines real numbers with requested precision of 6 decimal digits.
!
!  Discussion:
!
!    We use SELECTED_REAL_KIND to request a real type with
!    precision of 6 decimal digits and a maximum exponent of 30.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  integer, parameter :: precision6 = selected_real_kind ( 6, 30 )
  real ( kind = precision6 ) r

  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  Use SELECTED_REAL_KIND to request real numbers'
  write ( *, '(a)' ) '  with precision of 6 decimal digits.'

  if ( precision6 == -1 ) then
    write ( *, '(a)' ) ' '
