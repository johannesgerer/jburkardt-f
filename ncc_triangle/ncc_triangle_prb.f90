...
!  Discussion:
!
!    NCC_TRIANGLE_PRB runs tests on the NCC_TRIANGLE library.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'NCC_TRIANGLE_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the NCC_TRIANGLE library.'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  NCC_TRIANGLE_RULE_NUM returns the number of rules;'
  write ( *, '(a)' ) '  NCC_TRIANGLE_DEGREE returns the degree of a rule;'
  write ( *, '(a)' ) '  NCC_TRIANGLE_ORDER_NUM returns the order of a rule.'

  call ncc_triangle_rule_num ( rule_num )
  ...
  do rule = 1, rule_num
    call ncc_triangle_order_num ( rule, order_num )
    call ncc_triangle_degree ( rule, degree )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  NCC_TRIANGLE_RULE returns the points and weights'
  ...
  do rule = 1, rule_num
    ...
    call ncc_triangle_rule ( rule, order_num, xytab, wtab )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  NCC_TRIANGLE_RULE returns the points and weights of'
...
!
  ...
  write ( *, '(a)' ) '  sets of NCC points.'
  write ( *, '(a)' ) ' '

  call ncc_triangle_rule_num ( rule_num )

  file_name = 'ncc_triangle_rule_00.eps'
...
!
  ...
  call ncc_triangle_rule ( rule, order_num, xy, w )
!
