...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Investigate the polynomial exactness of a Gauss-Gegenbauer'
...
!
  if ( 3 <= arg_num ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'INT_EXACTNESS_GEGENBAUER:'
    write ( *, '(a)' ) '  ALPHA is the power of (1-X^2) in the weighting function.'
    write ( *, '(a)' ) ' '
...
!
  ...
  write ( *, '(a)'       ) '    Integral ( -1 <= x <= +1 ) (1-x^2)^alpha f(x) dx'
...
!
  ...
  do degree = 0, degree_max
    ...
    call monomial_quadrature_gegenbauer ( expon, alpha, order, w, x, quad_error )
