...
subroutine nco_triangle_degree ( rule, degree )
...
!
  ...
  if ( 1 <= rule .and. rule <= 9 ) then
    ...
    degree = -1
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCO_TRIANGLE_DEGREE - Fatal error!'
...
subroutine nco_triangle_order_num ( rule, order_num )
...
!
  ...
  call nco_triangle_suborder ( rule, suborder_num, suborder )
...
subroutine nco_triangle_rule ( rule, order_num, xy, w )
...
!
  ...
  do s = 1, suborder_num
    ...
    if ( suborder(s) == 1 ) then
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'NCO_TRIANGLE_RULE - Fatal error!'
...
subroutine nco_triangle_rule_num ( rule_num )
...
subroutine nco_triangle_suborder ( rule, suborder_num, suborder )
...
!
  ...
  if ( rule == 1 ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCO_TRIANGLE_SUBORDER - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
...
subroutine nco_triangle_suborder_num ( rule, suborder_num )
...
!
  ...
  if ( 1 <= rule .and. rule <= 9 ) then
    ...
    suborder_num = -1
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCO_TRIANGLE_SUBORDER_NUM - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
...
subroutine nco_triangle_subrule ( rule, suborder_num, suborder_xyz, suborder_w )
...
!
  ...
  if ( rule == 1 ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCO_TRIANGLE_SUBRULE - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
