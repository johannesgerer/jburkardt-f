...
!  Discussion:
!
!    NCO_TRIANGLE_PRB runs tests on the NCO_TRIANGLE library.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'NCO_TRIANGLE_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the NCO_TRIANGLE library.'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  NCO_TRIANGLE_RULE_NUM returns the number of rules;'
  write ( *, '(a)' ) '  NCO_TRIANGLE_DEGREE returns the degree of a rule;'
  write ( *, '(a)' ) '  NCO_TRIANGLE_ORDER_NUM returns the order of a rule.'

  call nco_triangle_rule_num ( rule_num )
  ...
  do rule = 1, rule_num
    call nco_triangle_order_num ( rule, order_num )
    call nco_triangle_degree ( rule, degree )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  NCO_TRIANGLE_RULE returns the points and weights'
  ...
  do rule = 1, rule_num
    ...
    call nco_triangle_rule ( rule, order_num, xytab, wtab )
...
!
  ...
  do rule = 1, rule_num
    ...
    call nco_triangle_suborder_num ( rule, suborder_num )

    allocate ( suborder_w(1:suborder_num) )
    allocate ( suborder_xyz(1:3,1:suborder_num) )

    call nco_triangle_subrule ( rule, suborder_num, suborder_xyz, suborder_w )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  NCO_TRIANGLE_RULE returns the points and weights of'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST05'
  write ( *, '(a)' ) '  This routine creates an EPS plot of some of the'
  write ( *, '(a)' ) '  sets of NCO points.'
  write ( *, '(a)' ) ' '

  call nco_triangle_rule_num ( rule_num )

  file_name = 'nco_triangle_rule_00.eps'
...
!
  ...
  call nco_triangle_rule ( rule, order_num, xy, w )
!
