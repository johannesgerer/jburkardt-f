...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'INT_EXACTNESS_LEGENDRE'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Investigate the polynomial exactness of a Gauss-Legendre'
  write ( *, '(a)' ) '  quadrature rule by integrating weighted '
  write ( *, '(a)' ) '  monomials up to a given degree over the [-1,+1] interval.'
!
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'INT_EXACTNESS_LEGENDRE: User input:'
...
!
  ...
  if ( dim_num /= 1 ) then
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'INT_EXACTNESS_LEGENDRE - Fatal error!'
...
!
  ...
  do degree = 0, degree_max
    ...
    call monomial_quadrature_legendre ( expon, order, w, x, quad_error )

    call monomial_quadrature_legendre ( expon, order, w2, x2, quad_error2 )
...
subroutine monomial_quadrature_legendre ( expon, order, w, x, quad_error )
