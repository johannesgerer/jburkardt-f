...
subroutine ncc_tetrahedron_degree ( rule, degree )
...
!
  ...
  if ( 1 <= rule .and. rule <= 7 ) then
    ...
    degree = -1
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCC_TETRAHEDRON_DEGREE - Fatal error!'
...
subroutine ncc_tetrahedron_order_num ( rule, order_num )
...
subroutine ncc_tetrahedron_rule ( rule, order_num, xyz, w )
...
!
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'NCC_TETRAHEDRON_RULE - Fatal error!'
...
subroutine ncc_tetrahedron_rule_num ( rule_num )
...
subroutine ncc_tetrahedron_suborder ( rule, suborder_num, suborder )
...
!
  ...
  if ( rule == 1 ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCC_TETRAHEDRON_SUBORDER - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
...
subroutine ncc_tetrahedron_suborder_num ( rule, suborder_num )
...
!
  ...
  if ( 1 <= rule .and. rule <= 7 ) then
    ...
    suborder_num = -1
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCC_TETRAHEDRON_SUBORDER_NUM - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
...
subroutine ncc_tetrahedron_subrule ( rule, suborder_num, suborder_xyz, &
  suborder_w )
...
!
  ...
  if ( rule == 1 ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'NCC_TETRAHEDRON_SUBRULE - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
