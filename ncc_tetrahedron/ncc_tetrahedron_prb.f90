...
!  Discussion:
!
!    NCC_TETRAHEDRON_PRB runs tests on the NCC_TETRAHEDRON library.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'NCC_TETRAHEDRON_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the NCC_TETRAHEDRON library.'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  NCC_TETRAHEDRON_RULE_NUM returns the number of rules;'
  write ( *, '(a)' ) '  NCC_TETRAHEDRON_DEGREE returns the degree of a rule;'
  write ( *, '(a)' ) '  NCC_TETRAHEDRON_ORDER_NUM returns the order of a rule.'

  call ncc_tetrahedron_rule_num ( rule_num )
  ...
  do rule = 1, rule_num
    call ncc_tetrahedron_order_num ( rule, order_num )
    call ncc_tetrahedron_degree ( rule, degree )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  NCC_TETRAHEDRON_RULE returns the points and weights'
  ...
  do rule = 1, rule_num
    ...
    call ncc_tetrahedron_rule ( rule, order_num, xyztab, wtab )
...
!
  ...
  do rule = 1, rule_num
    ...
    call ncc_tetrahedron_suborder_num ( rule, suborder_num )

    allocate ( suborder_w(1:suborder_num) )
    allocate ( suborder_xyz(1:4,1:suborder_num) )

    call ncc_tetrahedron_subrule ( rule, suborder_num, suborder_xyz, suborder_w )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  NCC_TETRAHEDRON_RULE returns the points and weights of'
...
!
  ...
  call ncc_tetrahedron_rule ( rule, order_num, xyz, w )
!
...
!
  ...
  call ncc_tetrahedron_suborder ( rule, suborder_num, suborder )
...
!*****************************************************************************80
!
!! TEST07 tests NCC_TETRAHEDRON_RULE.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  do rule = 1, rule_num
    ...
    call ncc_tetrahedron_subrule ( rule, suborder_num, suborder_xyz, &
      suborder_w )
