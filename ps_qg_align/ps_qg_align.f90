...
!
!    Input, integer ( kind = 4 ) N1, N2, the first and last columns of
...
!
  ...
  integer ( kind = 4 ), parameter :: TERMINATE = 8
...
!
!    Input, integer ( kind = 4 ) M1, M2, the minimum and maximum rows.
!
!    Input, integer ( kind = 4 ) N, the number of entries in sequence B.
!
!    Input, integer ( kind = 4 ) N1, N2, the minimum and maximum columns.
!
...
!
!    Output, integer ( kind = 4 ) I1, J1, the beginning point of an optimal
...
!    Output, integer ( kind = 4 ) T(0:N), the backward pointer vector.
!
!    Output, integer ( kind = 4 ) I1, J1, the location of an optimal
...
!    Input, integer ( kind = 4 ) M, the number of entries in sequence A.
!
!    Input, integer ( kind = 4 ) M1, M2, the minimum and maximum rows to consider.
!
!    Input, integer ( kind = 4 ) N, the number of entries in sequence B.
!
!    Input, integer ( kind = 4 ) N1, N2, the minimum and maximum columns to consider.
!
!    Input, integer ( kind = 4 ) LDS, the declared upper first dimension of S.
!    LDS must be at least M.
!
...
!    Entries in the M1:M2 by N1:N2 block have been computed.
!
!    Output, integer ( kind = 4 ) I2, J2, the beginning of an optimal
...
!  Parameters:
!
!    Input, integer ( kind = 4 ) I2, J2, the starting point of the path.
!    M1 <= I2 <= M2, N1 <= J2 <= N2.
!
!    Input, integer ( kind = 4 ) M, the number of entries in the profile.
!
...
!    Output, integer ( kind = 4 ) T(0:N), the forward pointer vector.
!
!    Output, integer ( kind = 4 ) I2, J2, the location of an optimal
