...
!
  ...
  write ( *, '(a)' ) '  Read an associated triangulation dataset of ELEMENT_NUM '
...
!
  ...
  call r8mat_transpose_print_some ( dim_num, node_num_t3, node_xy_t3, 1, 1, 5, 5, &
...
!
  ...
  call i4mat_transpose_print_some ( element_order_t3, element_num, element_node_t3, &
    1, 1, 3, 10, '  3 by 10 portion ELEMENT_NODE_T3:' )
!
!  Detect and correct 0-based indexing.
!
  call mesh_base_one ( node_num_t3, element_order_t3, element_num, element_node_t3 )
!
!  Allocate space.
!
...
!
  ...
  call r8mat_transpose_print ( dim_num, node_num_t4, node_xy_t4, '  NODE_XY_T4:' )
!
