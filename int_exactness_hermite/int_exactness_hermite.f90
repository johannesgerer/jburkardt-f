...
!
  if ( 3 <= arg_num ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'INT_EXACTNESS_HERMITE:'
    write ( *, '(a)' ) '  OPTION specifies the weight function w(x):'
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '    0, the unweighted rule for:'
    write ( *, '(a)' ) '      Integral ( -oo < x < +oo )             f(x) dx'
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '    1, the physicist weighted rule for:'
    write ( *, '(a)' ) '      Integral ( -oo < x < +oo ) exp(-x*x)   f(x) dx'
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '    2, the probabilist weighted rule for:'
    write ( *, '(a)' ) '      Integral ( -oo < x < +oo ) exp(-x*x/2) f(x) dx'
    write ( *, '(a)' ) ' '
  ...
  if ( option < 0 .or. 2 < option ) then
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'INT_EXACTNESS_HERMITE - Fatal error!'
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'INT_EXACTNESS_HERMITE: User input:'
...
!
  ...
  do degree = 0, degree_max
    ...
    call monomial_quadrature_hermite ( degree, order, option, w, x, quad_error )

    write ( *, '(2x,f24.16,3x,i2,4x,i2)' ) quad_error, degree
...
!
  ...
  if ( n < 0 ) then
    ...
    value = r8_factorial2 ( n - 1 ) * sqrt ( 2.0E+00 * pi )

  end if

  return
end
subroutine monomial_quadrature_hermite ( expon, order, option, w, x, &
  quad_error )
