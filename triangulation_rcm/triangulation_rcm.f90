...
!
  ...
  write ( *, '(a)' ) '  Read an associated triangulation dataset of TRIANGLE_NUM '
...
!
!    Output, integer ( kind = 4 ) ADJ_PERM_BANDWIDTH, the bandwidth of the permuted adjacency
!    matrix.
!
  implicit none
...
!
!    Output, integer ( kind = 4 ) ADJ_ROW(NODE_NUM+1).  Information about row I is stored
!    in entries ADJ_ROW(I) through ADJ_ROW(I+1)-1 of ADJ.
!
  implicit none
